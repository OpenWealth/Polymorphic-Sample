...
class Equity(FinancialInstrument):
    ...
    country_of_risk: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="ISO2 country code.", alias="countryOfRisk")
    __properties: ClassVar[List[str]] = ["type", "name", "identificationList", "countryOfRisk"]
    ...
    @field_validator('country_of_risk')
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "countryOfRisk": obj.get("countryOfRisk")
        })
        return _obj
